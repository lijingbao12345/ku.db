...
public class Rv2Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public   List<DatasBean> list = new ArrayList<>();
    ...
    private int ITEM_TWO = 2;
        ...
        private onLongClickSelect onLongClickSelect;

    public void setOnLongClickSelect(Rv2Adapter.onLongClickSelect onLongClickSelect) {
        this.onLongClickSelect = onLongClickSelect;
    }

    public void setOnClickSelect(Rv2Adapter.onClickSelect onClickSelect) {
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (onLongClickSelect!=null){
                    onLongClickSelect.onLongClickSelect(position);
                }
                return false;
            }
        });
    ...
    public void setDelete(DatasBean datasBean) {
    ...
    public interface onLongClickSelect{
        void onLongClickSelect(int position);
    }
}
